		...
		<div class="features_columns">
			...
			<div class="two features_columns_single">
					<div class="entry-featuredImg">
						<a href="' .esc_url('2021/11/18/about-anat/'). '">
							<?php if($choosePageBox1): ?>
			...
			<div >
					<div>
						<table>
							<tbody>
								<tr>
									<td style="width:10%;border:2px solid white; border-right: none; text-align:center;">Capabilities</td>
									<td style="width: 2%; border: none; border-right: 2px solid white; border-top: 2px solid white; border-bottom: 2px solid white;">&rarr;</td>
									<td style="border:none; width: 1%;"></td>
									<td style="width:10%;height:75%;border:2px solid white; border-right: none; text-align:center;">Industries</td>
									<td style="width: 2%; border: none; border-right: 2px solid white; border-top: 2px solid white; border-bottom: 2px solid white;">&rarr;</td>
									<td style="border:none;  width: 1%;"></td>
									<td style="width: 10%;height:75%;border:2px solid white; border-right: none; text-align:center;">How we work</td>
									<td style="width: 2%; border: none; border-right: 2px solid white; border-top: 2px solid white; border-bottom: 2px solid white;">&rarr;</td>
								</tr>
							</tbody>
						</table>
