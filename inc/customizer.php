...
function freddo_custom_settings_register( $wp_customize ) {
	...
	*/
	...
	/* Read More Text */
	$wp_customize->add_setting('freddo_theme_options[_readmore_text]', array(
		'sanitize_callback' => 'freddo_sanitize_text',
		'default'    => __( 'Read More', 'freddo' ),
		'type'       => 'option',
		'capability' => 'edit_theme_options'
	) );
	$wp_customize->add_control('freddo_theme_options[_readmore_text]', array(
		'label'      => __( 'Read More text', 'freddo' ),
		'section'    => 'cresta_freddo_theme_options_postpage',
		'settings'   => 'freddo_theme_options[_readmore_text]',
		'active_callback' => 'freddo_is_excerpt',
		'type'       => 'text',
		'priority' => 3,
	) );
	...
	*/
	...
	/* Blog Dropdown pages */
	$wp_customize->add_setting('freddo_theme_options[contact]', array(
		'default'    => true,
		'type'       => 'option',
		'capability' => 'edit_theme_options',
		'sanitize_callback' => 'absint',
	) );
	$wp_customize->add_control('freddo_theme_options[_onepage_choosepage_contact]', array(
		'label'      => __( 'Choose the page to display', 'freddo' ),
		'description'	=> __( 'Title, content and featured image will be used in the box', 'freddo' ),
		'section'    => 'cresta_freddo_onepage_section_contact',
		'settings'   => 'freddo_theme_options[_onepage_choosepage_contact]',
		'type'       => 'dropdown-pages',
...
function freddo_is_excerpt() {
	$isExcerpt = freddo_options('_showpost_type', 'excerpt');
	if ($isExcerpt == 'excerpt') {
		return true;
	}
	return false;
}
