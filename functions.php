...
function freddo_scripts() {
	...
	if ( freddo_options('_smooth_scroll', '1') == 1) {
		wp_enqueue_script( 'freddo-smooth-scroll', get_template_directory_uri() . '/js/SmoothScroll.min.js', array(), '1.4.9', true );
	}
	if (is_page_template('template-onepage.php')) {
		wp_enqueue_script( 'freddo-onepage', get_template_directory_uri() . '/js/jquery.onepage.min.js', array('jquery'), wp_get_theme()->get('Version'), true );
	...
	if (is_page_template('template-onepage.php') && freddo_options('_onepage_section_slider', '') == 1) {
		wp_enqueue_script( 'freddo-flex-slider', get_template_directory_uri() . '/js/jquery.flexslider-min.js', array('jquery'), '2.7.2', true );
	}
